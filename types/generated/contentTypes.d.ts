...
export interface ApiCommunityPageCommunityPage
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    finalCtaTitle: Schema.Attribute.Text;
    ...
    > &
      Schema.Attribute.Private;
    networkSubtitle: Schema.Attribute.Text;
    networkTitle: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    valuesSubtitle: Schema.Attribute.Text;
    valuesTitle: Schema.Attribute.Text;
  };
}
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    memberOnly: Schema.Attribute.Boolean;
    publishedAt: Schema.Attribute.DateTime;
    registrationLink: Schema.Attribute.String;
    state: Schema.Attribute.Enumeration<['upcoming', 'past']>;
    title: Schema.Attribute.String;
...
export interface ApiEventsPageEventsPage extends Struct.CollectionTypeSchema {
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['allgemein', 'mentoring', 'community', 'events']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiGeneralGeneral extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    impactStats: Schema.Attribute.Component<'shared.impact-state', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::general.general'
...
export interface ApiHomepageHomepage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    communityInfoBlocks: Schema.Attribute.Component<
      'shared.community-info-blocks',
      true
    >;
    communitySubtitle: Schema.Attribute.Text;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    finalCtaTitle: Schema.Attribute.Text;
    helpCards: Schema.Attribute.Component<'shared.help-cards', true>;
    helpSubtitle: Schema.Attribute.Text;
    helpTitle: Schema.Attribute.String;
    heroCtaLabel: Schema.Attribute.String;
    heroCtaSecondaryLabel: Schema.Attribute.Text;
    heroDescription: Schema.Attribute.Text;
    heroLead: Schema.Attribute.String;
    heroTitle: Schema.Attribute.String;
    image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wasMachtLegmonCards: Schema.Attribute.Component<
      'shared.was-macht-legmon-cards',
      true
    >;
    wasMachtLegmonSubtitle: Schema.Attribute.Text;
    wasMachtLegmonTitle: Schema.Attribute.String;
  };
}
...
export interface ApiMentoringPageMentoringPage
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    howItWorksTitle: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sliderInstruction: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStoryStory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    type: Schema.Attribute.Enumeration<['text', 'video', 'photo']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiWirkungPageWirkungPage extends Struct.CollectionTypeSchema {
  collectionName: 'wirkung_pages';
  info: {
    displayName: 'WirkungPage';
    pluralName: 'wirkung-pages';
    singularName: 'wirkung-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::wirkung-page.wirkung-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    statsSubtitle: Schema.Attribute.Text;
    statsTitle: Schema.Attribute.Text;
    storiesSubtitle: Schema.Attribute.Text;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::wirkung-page.wirkung-page': ApiWirkungPageWirkungPage;
